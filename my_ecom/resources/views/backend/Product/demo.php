      ...
      <form action="{{route('product.manage_product_process')}}" method="post"  enctype="multipart/form-data">
         ...
         <div class="row">
            <div class="col-md-6 mb-4 d-flex align-items-center">
               <div class="form-outline datepicker w-100">
                  <input type="text" class="form-control form-control-lg" name="brand" value="{{$brand}}" required/>
         ...
         <div class="row">
            <div class="col-md-6 mb-4 pb-2">
               <div class="form-outline">
                  <input type="text" name="shot_decs" value="{{$shot_decs}}" class="form-control form-control-lg" required/>
                  <label class="form-label" for="shot_decs">Shot_decs</label>
               </div>
            </div>
            <div class="col-md-6 mb-4 pb-2">
               <div class="form-outline">
                  <input type="text" name="desc" value="{{$desc}}" class="form-control form-control-lg" required/>
         ...
         <div class="row">
            ...
            <div class="col-md-6 mb-4">
               <div class="form-outline">
                  <input type="text" name="technical_sepcification" value="{{$technical_sepcification}}" class="form-control form-control-lg" required/>
                  <label class="form-label" for="technical_sepcification">Technical_sepcification</label>
               </div>
            </div>
         </div>
         <div class="row">
      ...
      <div class="row" id="product_images_box">
            <div class="product_images_{{$loop_count_num++}} col-md-4 mt-3" >
               ...
               <label class="form-label" for="attr_image">Image</label>
                  <input type="file" id="images" name="images[]" value="{{$pIArr['images']}}" class="form-control form-control" required/>
               @if($pIArr['images']!='')    
   ...
   <div class="card-body">
      ...
      <div class="row">
            ...
            <div class="col-md-4 mt-3">
               <div class="form-outline">
               <label class="form-label" for="attr_image">Image</label>
                  <input type="file" id="attr_image" name="attr_image[]" value="{{$pAArr['attr_image']}}" class="form-control form-control" required/>
               @if($pAArr['attr_image']!='')    
...
<script>
   ...
   function add_more(){
    ...
    function add_image_more(){
      loop_image_count++;
     var html='<div class="col-md-4 mt-3 product_images_'+loop_image_count+'"><label class="form-label mb-1" for="images">Images</label><input type="file" id="images" name="images[]" value="" class="form-control form-control"/></div>';
