          ...
          <div class="aa-product-details-area">
              ...
              <div class="row">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <p class="aa-product-avilability">Avilability: <span>In stock</span><br>
                      @if($product[0]->lead_time!='')
                      <span class="text-danger"><b>{{$product[0]->lead_time}}</b></span></p>
                      @endif
                    </div>
                    <p class="text-warning"><b>{!!$product[0]->shot_decs!!}<b></p>
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="javascript:void(0)" onclick="add_to_cart('{{$product[0]->id}}',
                      '{{$product_attr[$product[0]->id][0]->color_id}}','{{$product_attr[$product[0]->id][0]->size_id}}')">Add To Cart</a>
            ...
            <div class="aa-product-details-bottom">
              <ul class="nav nav-tabs" id="myTab2">
                ...
                <li><a href="#technical_sepcification" data-toggle="tab">Technical sepcification</a></li>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade" id="technical_sepcification">
                {!! $product[0]->technical_sepcification !!}
                </div>
