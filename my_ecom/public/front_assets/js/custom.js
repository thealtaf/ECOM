...
function showColor(size){
  ...
  jQuery('.size_link').css('border','1px sohid #ddd');
...
if(size_str_id==0 && color_str_id==0){
  ...
  color_id='No';
   ...
   if(size_id=='' && size_id!='No'){
       jQuery('#add_to_cart_msg').html('<div class="alert alert-danger alert-dismissible fade in"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> Please Select Size</div>');
   }else if(color_id=='' && color_id!='No'){
       jQuery('#add_to_cart_msg').html('<div class="alert alert-danger alert-dismissible fade in"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> Please Select Color</div>');
   }else{
